...
class Keccak:
    ...
    def setB(self, b):
        ...
        if b not in [25, 50, 100, 200, 400, 800, 1600]:
            raise KeccakError.KeccakError(
                "b value not supported - use 25, 50, 100, 200, 400, 800 or 1600"
            )
    ...
    def pad10star1(self, M, n):
        ...
        if my_string_length > (len(my_string) // 2 * 8):
            raise KeccakError.KeccakError(
                "the string is too short to contain the number of bits announced"
            )
    ...
    def Keccak(self, M, r=1024, c=512, n=1024, verbose=False):
        ...
        # The lane length (r + c) // 25 is what setB above already derived.
