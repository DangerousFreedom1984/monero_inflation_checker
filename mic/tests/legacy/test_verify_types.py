...
Run with::
    ...
    python -m unittest mic.tests.legacy.test_verify_types
"""
...
MAINNET_NODE = os.environ.get("MIC_MAINNET_NODE", "http://xmr-node.cakewallet.com:18081/")
...
FCMP_PROOF = os.path.join(_DATA, "fcmp_testnet_example.json")
FCMP_PARAMS = PARAMS_FILE
...
class TestVerifyFcmpType7(unittest.TestCase):
    ...
    def test_type7_fcmp_plus_plus(self):
        ...
        self.assertTrue(os.path.exists(FCMP_PROOF), "captured FCMP++ proof missing")
