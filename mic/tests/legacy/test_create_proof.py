...
Run with::
    ...
    python -m unittest mic.tests.legacy.test_create_proof
"""
...
from mic.common.df25519 import Scalar, random_scalar
from mic.rangeproofs import check_rangeproofs as cr
