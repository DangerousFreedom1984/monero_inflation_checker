...
def grootle_prove(M,l,C_offset,privkey,n,m,message):
    ...
    for j in range(m):
        ...
        proof.X[j] = rho[j]*dumber25519.G + dumber25519.multiexp(data_x_scalars,data_x_points)
...
M= PointVector([ Point('4e5962db310865eb1f8a404cd89578907578ce902b328d76a3848934379271d0'),Point('dda19cc4cd1d693ee1cf502ba286b87ce2a3629319a2c98fabbe802de681b148'),Point('c5e4b20c80cb007f73e385d9ddb5dd9d5769daf25e48e7e3a61521006910433f'),Point('7b03f30c6860dee10619f16eb08551ca2b0b750d093072d53a86b6620ad0554c'),])
