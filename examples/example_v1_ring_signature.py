...
This is a *specific, runnable demonstration* — it is intentionally kept out of the
...
import mic_paths  # noqa: E402,F401
...
def main():
    ...
    # Fresh signer key and the matching key image I = x * Hp(P).
